...
def old_old_f(M):
    ...
    print("here are the beta masses from old code")
    print(beta_masses)
...
def old_f(M):
    ...
    def beta_masses(mass, spin):
        ...
        beta_mass = (hbar * c**3 * beta_values[spin]) / (8 * math.pi * G * mass)    
        return beta_mass

    print("here are the beta_mass values for new code")
    print(beta_masses(masses['mu'], '1/2'))
    print(beta_masses(masses['u'], '1/2'))
    print(beta_masses(masses['d'], '1/2'))
    print(beta_masses(masses['s'], '1/2'))
    print(beta_masses(masses['c'], '1/2'))
    print(beta_masses(masses['T'], '1/2'))
    print(beta_masses(masses['b'], '1/2'))
    print(beta_masses(masses['t'], '1/2'))
    print(beta_masses(masses['g'], '1'))
    print(beta_masses(masses['w'], '1'))
    print(beta_masses(masses['z'], '1'))
    print(beta_masses(masses['h'], '0'))
...
f_values = f(M_values)
old_old_f_values = old_old_f(M_values)

print(f_values)
print(old_old_f_values)

# Plot the function using logarithmic scales
plt.figure(figsize=(12, 8))
plt.semilogx(M_values, new_f_values, label='$f(M)$', color='blue', linewidth=2)
